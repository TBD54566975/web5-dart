...
enum DnsType {
  ...
  const DnsType(this.value, this.name);

  static DnsType fromValue(int value) {
    return DnsType.values.firstWhere(
      (type) => type.value == value,
      orElse: () => DnsType.UNKNOWN,
    );
  }

  static DnsType fromName(String name) {
    return DnsType.values.firstWhere(
